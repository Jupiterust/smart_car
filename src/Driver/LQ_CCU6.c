...
//    }
    ...
    if(is_crossing_line1 == true){
        following_speed[0] = 20;
        following_speed[1] = 20;
        following_speed[2] = 20;
        following_speed[3] = 20;
        angle_correct(0.0f,20);
    }
