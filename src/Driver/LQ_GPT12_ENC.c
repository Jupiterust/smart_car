...
unsigned int Get_encoder(ENC_InputPin_t Input_Pin){
    unsigned int value;
    switch(ENC_GetTimer(Input_Pin))
    {
    case 2:
      value = MODULE_GPT120.T2.U;
      MODULE_GPT120.T2.U = 0;
      break;

    case 3:
      value = MODULE_GPT120.T3.U;
      MODULE_GPT120.T3.U = 0;
      break;

    case 4:
      value = MODULE_GPT120.T4.U;
      MODULE_GPT120.T4.U = 0;
      break;

    case 5:
      value = MODULE_GPT120.T5.U;
      MODULE_GPT120.T5.U = 0;
      break;

    case 6:
      value = MODULE_GPT120.T6.U;
      MODULE_GPT120.T6.U = 0;
      break;
    }
    return value;
