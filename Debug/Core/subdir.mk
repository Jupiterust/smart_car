...
clean-Core:
	-$(RM) ./Core/Communication.d ./Core/Communication.o ./Core/Communication.src ./Core/Motor.d ./Core/Motor.o ./Core/Motor.src ./Core/Servo.d ./Core/Servo.o ./Core/Servo.src ./Core/Task.d ./Core/Task.o ./Core/Task.src ./Core/cheju.d ./Core/cheju.o ./Core/cheju.src ./Core/motified_app.d ./Core/motified_app.o ./Core/motified_app.src
