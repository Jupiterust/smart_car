...
extern volatile coordinate_struct TASK3_SHOOT_IN_ONE_DIS_S1[2];
extern volatile coordinate_struct TASK3_SHOOT_IN_ONE_DIS_S2[2];
extern volatile coordinate_struct TASK3_SHOOT_IN_ONE_DIS_S3[2];
extern volatile coordinate_struct TASK3_SHOOT_IN_ONE_DIS_S4[2];
...
// task4
extern volatile coordinate_struct TASK4_STEP_MOVE1[2];

extern volatile coordinate_struct TASK4_STEP_MOVE2[2];
extern volatile coordinate_struct TASK4_STEP_MOVE3[2];
extern volatile coordinate_struct TASK4_STEP_MOVE4[2];
extern volatile coordinate_struct TASK4_STEP_MOVE5[2];
extern volatile coordinate_struct TASK4_STEP_MOVE6[2];
extern volatile coordinate_struct TASK4_STEP_MOVE7[2];
...
extern volatile bool does_task3_start_to_count;
...
extern volatile bool temp_task3_speed_stop;
