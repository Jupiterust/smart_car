...
void PID_init(void){
    ...
    motor_pid.k_i[0] = 24.951f;
    motor_pid.k_i[1] = 24.951f;
    motor_pid.k_i[2] = 24.951f;
    motor_pid.k_i[3] = 24.951f;
...
void task1_encounter_small_cy_in_one(void){
    point_number = 3;
    task1_encounter_small_cy_in_one_S[0].target_speed.x_y[0] =  -18.7;
    task1_encounter_small_cy_in_one_S[0].target_speed.x_y[1] =   18.7;
...
void task1_back_to_two_from_small_cy(void){
    ...
    task1_back_to_two_from_small_cy_S[1].delta_distance.x_y_path = 9.1f;
...
void task1_back_to_following_from_small_cy(void){
    ...
    task1_back_to_following_from_small_cy_S[1].target_speed.x_y[0] =  26;
    task1_back_to_following_from_small_cy_S[1].target_speed.x_y[1] =  26;
    task1_back_to_following_from_small_cy_S[1].target_speed.x_y[2] =  26;
    task1_back_to_following_from_small_cy_S[1].target_speed.x_y[3] =  26;
...
void task1_back_to_following_from_large_cy(void){
    ...
    task1_back_to_following_from_large_cy_S[1].target_speed.x_y[0] =    25;
    task1_back_to_following_from_large_cy_S[1].target_speed.x_y[1] =    25;
    task1_back_to_following_from_large_cy_S[1].target_speed.x_y[2] =    25;
    task1_back_to_following_from_large_cy_S[1].target_speed.x_y[3] =    25;

    task1_back_to_following_from_large_cy_S[1].flag = dis_start_y;

    task1_back_to_following_from_large_cy_S[1].delta_distance.x_y_path = 23.45f;
...
void following_flow1_init(void){
    ...
    following_flow1[1].delta_distance.angle = 42.01f;
...
void TASK2_CORRECT_INIT(void){
    ...
    task2_to_correct_S[0].delta_distance.x_y_path = 2.429f;
    ...
    task2_to_correct_S[1].delta_distance.x_y_path = 1.029f;
...
volatile coordinate_struct TASK3_SHOOT_IN_ONE_DIS_S1[2] = {0};

volatile coordinate_struct TASK3_SHOOT_IN_ONE_DIS_S2[2] = {0};

volatile coordinate_struct TASK3_SHOOT_IN_ONE_DIS_S3[2] = {0};

volatile coordinate_struct TASK3_SHOOT_IN_ONE_DIS_S4[2] = {0};
...
void task3_correct_pos_init(void){
    TASK3_CORRECT_POS_S[0].target_speed.x_y[0] =  20;
    TASK3_CORRECT_POS_S[0].target_speed.x_y[1] =  20;
    TASK3_CORRECT_POS_S[0].target_speed.x_y[2] =  20;
    TASK3_CORRECT_POS_S[0].target_speed.x_y[3] =  20;

    TASK3_CORRECT_POS_S[0].flag = dis_start_y;

    TASK3_CORRECT_POS_S[0].delta_distance.x_y_path = 10.629f;
    ...
    TASK3_CORRECT_POS_S[1].delta_distance.x_y_path = 0.129f;

    TASK3_CORRECT_POS_S[1].next_flag = dis_idle;
}

void task3_shoot_in_one_dis_init(void){
    TASK3_SHOOT_IN_ONE_DIS_S1[0].target_speed.x_y[0] =  25;
    TASK3_SHOOT_IN_ONE_DIS_S1[0].target_speed.x_y[1] =  25;
    TASK3_SHOOT_IN_ONE_DIS_S1[0].target_speed.x_y[2] =  25;
    TASK3_SHOOT_IN_ONE_DIS_S1[0].target_speed.x_y[3] =  25;
    ...
    TASK3_SHOOT_IN_ONE_DIS_S2[0].target_speed.x_y[0] =  25;
    TASK3_SHOOT_IN_ONE_DIS_S2[0].target_speed.x_y[1] =  25;
    TASK3_SHOOT_IN_ONE_DIS_S2[0].target_speed.x_y[2] =  25;
    TASK3_SHOOT_IN_ONE_DIS_S2[0].target_speed.x_y[3] =  25;
    ...
    TASK3_SHOOT_IN_ONE_DIS_S3[0].target_speed.x_y[0] =  25;
    TASK3_SHOOT_IN_ONE_DIS_S3[0].target_speed.x_y[1] =  25;
    TASK3_SHOOT_IN_ONE_DIS_S3[0].target_speed.x_y[2] =  25;
    TASK3_SHOOT_IN_ONE_DIS_S3[0].target_speed.x_y[3] =  25;
...
volatile coordinate_struct TASK4_STEP_MOVE1[2] = {0};

volatile coordinate_struct TASK4_STEP_MOVE2[2] = {0};
volatile coordinate_struct TASK4_STEP_MOVE3[2] = {0};
volatile coordinate_struct TASK4_STEP_MOVE4[2] = {0};
volatile coordinate_struct TASK4_STEP_MOVE5[2] = {0};
volatile coordinate_struct TASK4_STEP_MOVE6[2] = {0};
volatile coordinate_struct TASK4_STEP_MOVE7[2] = {0};

volatile coordinate_struct TASK4_CORRECT_MOVE[2] = {0};
...
void task4_step_move_init(void){
    ...
    TASK4_CORRECT_MOVE[0].target_speed.x_y[0] =  -15;
    TASK4_CORRECT_MOVE[0].target_speed.x_y[1] =  -15;
    TASK4_CORRECT_MOVE[0].target_speed.x_y[2] =  -15;
    TASK4_CORRECT_MOVE[0].target_speed.x_y[3] =  -15;
...
//            }
            ...
            if(task2_go_back_to_in_one == true){
                task2_go_back_to_in_one = false;
            }

            if(task2_go_back_to_in_two == true){
                task2_go_back_to_in_two = false;
            }
...
volatile bool temp_task3_speed_stop = false;
#define CROSS_LINE_DURATION_CNT1 530
...
void crossing_line_handle(void){
    ...
    static float yaw_dev_threshold = 46.0f; // yaw判定容差
