...
//  printf("%d\r\n",res);
    DUMMY_INIT();
    FSUS_SetServoAngle(servo_usart, 1, -90.0f, 1000, 0);
    delayms(20);
    ...
    delayms(20);
    FSUS_SetServoAngle(servo_usart, 5, -90.0f, 20, 0);//76
    delayms(20);
...
//    delayms(2000);
    ...
    //TASK3_WATCH_WORM();task3_speed_edit = true;
    // {90.0f,  180.0f, -132.0f,-15.0f }
    //   16      -89 -20
//    SyncArray[0].interval_single = 1600; SyncArray[0].angle = 90.0f;
//    SyncArray[1].interval_single = 10;   SyncArray[1].angle = 16.0f;
//    SyncArray[2].interval_single = 500;  SyncArray[2].angle = -89.0f;
//    SyncArray[3].interval_single = 500;  SyncArray[3].angle = -20.0f;
//    FSUS_SyncCommand(servo_usart, 4, 1, SyncArray);
...
//    worm_record_array[0] = 1;
//    worm_record_array[2] = 1;
//    worm_record_array[3] = 1;
...
//        }
        ...
        if(look_at_worm == true && is_waiting_for_task_record == true){
            ...
            temp_task3_speed_stop = true;
            following_speed[0] = 0;
            following_speed[1] = 0;
            following_speed[2] = 0;
            following_speed[3] = 0;
            delayms(400);
            temp_task3_speed_stop = false;
        }
        ...
        sprintf(txt, "t3:%d %d ", task4_speed_adjust_start, tast3_start_to_shoot);
